  ...
  <div class="atlas-shell">
   <div class="grid gap-12 lg:grid-cols-12">
    <div class="lg:col-span-7">
     <p class="atlas-label">Make the next decision with better evidence</p>
     <h2 class="atlas-display mt-6 max-w-4xl text-[clamp(3.3rem,7vw,7rem)] leading-[0.88]">Bring us the context. We will find the signal.</h2>
