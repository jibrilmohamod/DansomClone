 ...
 <div class="absolute inset-0 z-50 h-[100vh] overflow-y-auto bg-gradient-to-b from-white via-slate-50 to-white text-slate-900">
  ...
  <div class="space-y-4 px-4 pb-6">
   ...
   <a
    ...
    class="inline-flex min-h-11 items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm"
   >
    <IconCSS name="mdi:linkedin" class="text-2xl text-secondary" />
    LinkedIn
   </a>
