  ...
  <div class="hidden md:block">
   <div class="container">
    ...
    <div class="flex items-center justify-between rounded-[18px] border border-white/10 bg-white/5 px-5 py-3 backdrop-blur-xl shadow-glow">
     ...
     <NuxtLink
      to="/Contact"
      class="group inline-flex items-center gap-2 rounded-full bg-secondary px-4 py-2 text-sm font-semibold text-surface shadow-glow transition hover:-translate-y-1"
     >
      Book a call
