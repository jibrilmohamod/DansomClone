...
<template>
  <div>
    <div>
      <div
        class="hidden md:block h-fit inset-0 z-50 container mx-auto text-white"
      >
        ...
        <div class="flex items-center py-5">
          ...
          <div class="flex-grow flex justify-end items-center gap-5">
            ...
            <div class="flex-grow flex justify-end items-center gap-5">
              ...
              <NuxtLink to="/contactus" class="border-button text-lg font-Lora">
                Contact Us
              </NuxtLink>
            </div>
            <!-- button -->
