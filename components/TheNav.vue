  ...
  <div class="w-full px-4 py-3 md:hidden">
   <nav class="w-full">
    <ul class="flex w-full items-center justify-between">
     <li class="rounded-full border border-slate-300 bg-white p-2.5 shadow-sm" @click="toggleMobileNav()">
      <Icon name="ci:menu-alt-01" class="text-[1.65rem] text-slate-700" />
     </li>

     <li>
      <NuxtLink to="/" class="flex items-center rounded-full border border-slate-200 bg-white px-2.5 py-1.5 shadow-sm">
