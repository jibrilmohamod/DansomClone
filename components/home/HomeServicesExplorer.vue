<template>
 <section id="capabilities" class="services-directory border-y border-line/35 bg-panel-soft/35 py-20 md:py-32 lg:py-40">
  <div class="shell">
   <div class="max-w-4xl">
    <h2 class="display-title text-4xl leading-[0.96] md:text-6xl lg:text-7xl">The right capability for the decision at hand.</h2>
   ...
   <div class="mt-14 grid gap-12 lg:mt-20 lg:grid-cols-12 lg:items-start">
    <div class="lg:sticky lg:top-24 lg:col-span-5">
     ...
     <p class="mt-6 max-w-md font-display text-2xl font-semibold leading-tight tracking-[-0.03em] text-mist md:text-3xl">
      One team from field evidence to practical action.
     </p>
    </div>
