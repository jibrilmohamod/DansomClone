  ...
  <div class="flex flex-1 flex-col gap-3 p-0 text-slate-900 md:gap-4 md:p-6">
   <div class="space-y-1">
    <div class="space-y-1.5">
     ...
     <span class="inline-flex items-center rounded-full border border-secondary/30 bg-secondary/10 px-2.5 py-1 text-[11px] font-semibold tracking-[0.08em] text-secondary md:px-3 md:text-xs">
      {{ role }}
     </span>
    </div>
   </div>
