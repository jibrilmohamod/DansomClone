<template>
 <div class="bg-tertiary min-h-screen text-quinary">
  ...
  <section class="container m-auto px-6 py-16 space-y-10">
   ...
   <div class="rounded-3xl bg-white p-6 shadow-xl shadow-slate-200 ring-1 ring-tertiary">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
     <div class="flex w-full flex-col gap-3 md:flex-row md:items-center md:gap-4">
      <input
       ...
       class="w-full rounded-xl border border-tertiary bg-tertiary px-4 py-3 text-sm placeholder:text-slate-500 focus:border-primary focus:outline-none md:w-1/2"
      />
      <div class="flex items-center gap-3 text-sm font-semibold text-primary">
       <p class="text-quinary">Filter by:</p>
       <select
        v-model="classification"
        class="rounded-xl border border-tertiary bg-tertiary px-3 py-2 text-sm focus:border-primary focus:outline-none"
       >
