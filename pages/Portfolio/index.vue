 ...
 <div>
  ...
  <section class="atlas-grid bg-ink py-20 md:py-28">
   <div class="atlas-shell">
    <RevealBlock class="grid gap-10 lg:grid-cols-12 lg:items-end"><div class="lg:col-span-8"><p class="atlas-label">Project portfolio</p><h2 class="atlas-display mt-6 max-w-[17ch] text-[clamp(2.4rem,4.4vw,4.4rem)] leading-[0.98]">Research, monitoring and advisory assignments.</h2></div><p class="border-t border-line/55 pt-5 text-base leading-relaxed text-mist/62 lg:col-span-3 lg:col-start-10">Monitoring, evaluation, research, logistics and advisory work delivered across the Horn of Africa.</p></RevealBlock>
    ...
    <div v-if="filteredProjectPool.length===0" class="border-y border-line/55 py-20 text-center"><h3 class="atlas-display text-3xl">No matching projects.</h3><p class="mt-3 text-mist/55">Try another project, partner or service.</p></div>
