<template>
 <div class="min-h-screen text-slate-900">
  ...
  <div class="container m-auto px-4 py-8 md:px-6 md:py-14">
   <div class="grid gap-5 rounded-3xl bg-white p-5 shadow-xl shadow-slate-200 ring-1 ring-slate-200 md:grid-cols-3 md:gap-8 md:p-8">
    <div class="flex flex-col items-center gap-4 md:col-span-1">
     <Image2Card :image="project.icon" />
     <div class="w-full rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
    ...
    <div class="md:col-span-2 space-y-4 font-Roboto md:space-y-6">
     <div class="space-y-2 md:space-y-3">
      <h3 class="text-2xl font-DM pb-1 md:pb-2 md:text-3xl">Classification</h3>
      <p class="text-base text-slate-700 md:text-lg">{{ project.classification }}</p>
     </div>
     <div class="space-y-2 md:space-y-3">
      <h3 class="text-2xl font-DM pb-1 md:pb-2 md:text-3xl">Description</h3>
      <p class="text-base text-slate-700 leading-relaxed md:text-lg">{{ project.description }}</p>
     </div>
