 ...
 <div class="bg-tertiary min-h-screen text-quinary">
  ...
  <section class="container mx-auto px-6 py-16 space-y-10">
   <div class="grid gap-8 md:grid-cols-3">
    <div class="md:col-span-2 rounded-3xl bg-white p-8 shadow-xl shadow-slate-200 ring-1 ring-tertiary">
     ...
     <form class="mt-8 grid gap-4">
      <div class="grid gap-4 md:grid-cols-2">
       <input
        ...
        id="name"
        placeholder="Name"
        class="w-full rounded-xl border border-tertiary bg-tertiary px-4 py-3 text-lg placeholder:text-slate-500 focus:border-primary focus:outline-none"
       />
       <input
        type="email"
        id="email"
      ...
      <textarea
       ...
       class="w-full rounded-xl border border-tertiary bg-tertiary px-4 py-4 text-lg placeholder:text-slate-500 focus:border-primary focus:outline-none md:h-48"
      ></textarea>
      <button
       type="submit"
    ...
    <div class="space-y-4 rounded-3xl bg-gradient-to-b from-primary via-quinary to-primary text-white p-8 shadow-lg shadow-primary/20">
