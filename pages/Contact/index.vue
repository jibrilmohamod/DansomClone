<template>
 <div>
  <TheHeader
   title="Bring us the unknown"
   eyebrow="Start a conversation"
   intro="Share the context, objectives, and uncertainty. We will bring the right regional and technical expertise."
  >
   <template #image>
    <img
     loading="eager"
     ...
     <form class="mt-16 border-t border-line/55" @submit.prevent="sendEmail">
      <div class="grid border-b border-line/55 py-7 md:grid-cols-[10rem_1fr] md:items-center">
       ...
       <input
        ...
        required
        placeholder="Name"
        class="mt-3 w-full border-0 bg-transparent p-0 font-display text-3xl text-mist placeholder:text-mist/[0.28] focus:ring-0 md:mt-0 md:text-5xl"
       />
      </div>
      <div class="grid border-b border-line/55 py-7 md:grid-cols-[10rem_1fr] md:items-center">
      ...
      <div class="border-b border-line/55 py-7">
       ...
       <textarea
        ...
        class="mt-5 w-full resize-y border-0 bg-transparent p-0 font-display text-3xl leading-tight text-mist placeholder:text-mist/[0.28] focus:ring-0 md:text-5xl"
       ></textarea>
      </div>
