 ...
 <div class="text-slate-900">
  ...
  <section id="home-intro" class="container px-6 py-16 md:py-20">
   <div class="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
    <div class="dansom-card animate-fade-up space-y-6 p-8 backdrop-blur-xl">
     ...
     <div class="grid gap-4 sm:grid-cols-2">
      <div class="dansom-card-soft flex items-start gap-3 p-4 transition hover:-translate-y-1">
    ...
    <div class="relative">
     <div class="dansom-card relative overflow-hidden">
      <NuxtImg
       provider="cloudinary"
       format="webp"
       loading="lazy"
   ...
   <div class="container relative px-6 space-y-12">
    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
     <div
      ...
      :key="service.title"
      class="dansom-card group relative overflow-hidden p-6 shadow-glow backdrop-blur transition duration-300 hover:-translate-y-2 hover:border-secondary/50 hover:shadow-xl"
     >
  ...
  <section class="py-16 md:py-20">
   <div class="container px-6">
    <div class="dansom-card grid gap-10 p-10 shadow-2xl shadow-slate-200">
     ...
     <div class="grid gap-6 md:grid-cols-3">
      <div
       ...
       :key="step.title"
       class="dansom-card-soft p-6 shadow-lg shadow-black/10 transition hover:-translate-y-1"
      >
  ...
  <section class="relative bg-slate-50/80 py-16 md:py-20">
   ...
   <div class="container relative px-6 space-y-8">
    <div class="grid items-start gap-10 lg:grid-cols-[0.95fr_1.05fr]">
     <div class="dansom-card space-y-6 p-8 shadow-glow backdrop-blur">
      <div class="space-y-4">
      ...
      <div class="grid gap-4 sm:grid-cols-2">
       <div
        ...
        :key="signal.title"
        class="dansom-card-soft relative overflow-hidden p-4"
       >
     ...
     <div class="grid gap-4 md:grid-cols-2">
      <article
       ...
       :key="project.title"
       class="dansom-card group relative overflow-hidden p-6 shadow-[0_30px_60px_-45px_rgba(15,23,42,0.55)] backdrop-blur"
      >
    ...
    <div class="dansom-card-soft p-3 shadow-inner shadow-slate-300/40 backdrop-blur">
  ...
  <section class="pb-16 md:pb-20">
   <div class="container px-6">
    <div class="dansom-card flex flex-col items-center gap-4 p-10 text-center shadow-glow backdrop-blur">
