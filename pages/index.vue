<template>
  <div class="">
    ...
    <UiComp
      header="Our Partners and Portfolio"
    ...
    <UiComp
      header="We can help you navigate what's next"
    ...
    >
      <template #image>
        ...
        <ImageCard
          image="https://res.cloudinary.com/dckmlqzgd/image/upload/v1713240777/countryside-women-out-field-posing_23-2148761775_wo8svm.jpg"
          class="pt-5"
        />
      </template>
      <template #image2>
