<template>
 <div class="text-slate-900">
  ...
  <section class="container mx-auto px-6 py-16">
   <div class="grid items-center gap-10 rounded-[28px] border border-slate-300 bg-white p-10 shadow-glow backdrop-blur-xl md:grid-cols-2">
    <div class="space-y-4">
    ...
    <div class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-inner shadow-slate-200">
