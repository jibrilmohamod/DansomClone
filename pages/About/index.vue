<template>
 <div class="relative overflow-hidden text-slate-900">
  <div class="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_12%_20%,rgba(80,174,211,0.14),transparent_28%),radial-gradient(circle_at_86%_8%,rgba(191,217,98,0.16),transparent_30%)]"></div>
  <div class="relative">
  ...
  <section class="container mx-auto px-6 py-16">
   <div class="dansom-card grid items-center gap-10 p-10 backdrop-blur-xl md:grid-cols-2">
    <div class="space-y-4">
     ...
     <p class="font-body text-lg leading-relaxed text-slate-700">
     ...
     <div class="grid gap-4 sm:grid-cols-2">
      <div class="dansom-card-soft p-4">
       <p class="text-3xl font-semibold text-slate-900">2009</p>
       <p class="text-sm text-slate-600">Founded to connect global partners with local insight</p>
      </div>
      <div class="dansom-card-soft p-4">
       <p class="text-3xl font-semibold text-slate-900">Full access</p>
       <p class="text-sm text-slate-600">Teams positioned across hard-to-reach regions</p>
      </div>
     </div>
    </div>
    <div class="dansom-card p-6 shadow-inner shadow-slate-200">
  ...
  <section class="py-16">
   <div class="container mx-auto grid items-center gap-10 px-6 md:grid-cols-2">
    <div class="relative rounded-[28px] border border-slate-200 bg-white p-6 shadow-2xl shadow-slate-300/50">
     <NuxtImg
      provider="cloudinary"
      loading="lazy"
      format="webp"
    ...
    <div class="space-y-5">
     ...
     <p class="font-body text-lg text-slate-700 leading-relaxed">
     ...
     <div class="grid gap-4 sm:grid-cols-2">
      <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
       <p class="text-lg font-semibold text-slate-900">Informed decisions</p>
       <p class="text-sm text-slate-600">Political economy analysis and security advisory to guide policy and programming.</p>
      </div>
      <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
       <p class="text-lg font-semibold text-slate-900">Community-first</p>
     ...
     <template #vfor>
      <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
       <article
        ...
        :key="service.title"
        class="dansom-card group relative overflow-hidden p-6"
       >
        <div class="absolute inset-0 bg-gradient-to-br from-secondary/10 via-transparent to-slate-100 opacity-0 transition-opacity duration-500 group-hover:opacity-100"></div>
        <div class="relative flex items-start justify-between gap-4">
         <span class="dansom-chip">Value</span>
         <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-secondary/15 text-2xl text-secondary ring-1 ring-secondary/20">
          <Icon :name="service.icon" />
         </div>
        </div>
        <h4 class="relative mt-5 text-xl font-semibold leading-tight text-slate-900">{{ service.title }}</h4>
        <p class="relative mt-3 text-base leading-relaxed text-slate-600">{{ service.subtitle }}</p>
        <div class="relative mt-6 h-1.5 overflow-hidden rounded-full bg-slate-200">
  ...
  <section class="py-16">
   <div class="container mx-auto grid gap-8 px-6 md:grid-cols-3">
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-glow">
