<template>
 <div class="text-slate-900">
  ...
  <section class="container mx-auto px-6 py-16 space-y-12">
   <div class="rounded-3xl border border-slate-300 bg-white p-8 shadow-glow backdrop-blur">
   ...
   <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
    <div
     ...
     :key="service.title"
     class="rounded-2xl border border-slate-300 bg-white p-6 shadow-glow backdrop-blur transition hover:-translate-y-2 hover:border-secondary/40"
    >
