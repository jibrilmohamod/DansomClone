  ...
  <div class="container m-auto px-4 py-6 md:px-6 md:py-14">
   <div class="grid gap-4 rounded-none border-0 bg-transparent p-0 shadow-none md:dansom-card md:grid-cols-3 md:gap-8 md:p-8">
    ...
    <div class="space-y-3 md:col-span-2 md:space-y-5">
     ...
     <p class="max-w-3xl rounded-xl border border-slate-200 bg-slate-50/80 px-4 py-3 text-justify font-body text-sm leading-relaxed text-slate-700 md:px-5 md:py-4 md:text-base">
      {{ service.subtitle }}
     </p>
     <div
      class="prose prose-sm max-w-none rounded-2xl border border-slate-200/90 bg-white p-4 text-justify prose-headings:text-primary prose-p:my-0 prose-p:mb-4 prose-p:leading-7 prose-ul:my-4 prose-ul:list-disc prose-ul:space-y-1 prose-ul:pl-6 prose-li:my-1 prose-a:text-secondary md:prose-base md:p-6"
