  ...
  <div class="container m-auto px-4 py-6 md:px-6 md:py-14">
   <div class="grid gap-4 rounded-none border-0 bg-transparent p-0 shadow-none md:dansom-card md:grid-cols-3 md:gap-8 md:p-8">
    ...
    <div class="space-y-3 md:col-span-2 md:space-y-5">
     ...
     <div
      class="prose prose-sm max-w-none text-justify prose-headings:text-primary prose-p:my-0 prose-p:mb-5 prose-p:leading-8 prose-ul:my-5 prose-ul:list-disc prose-ul:space-y-2 prose-ul:pl-6 prose-li:leading-7 prose-a:text-secondary md:prose-base"
