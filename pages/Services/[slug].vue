...
<script lang="ts" setup>
 ...
 useSeoMeta({
  title: () => service.value?.fullTitle || "Service",
  description: () =>
   service.value?.subtitle ||
   "Dansom consultancy service details across research, monitoring, evaluation, and advisory support.",
 })
</script>
