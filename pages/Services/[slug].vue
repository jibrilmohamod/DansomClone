<template>
 <div class="min-h-screen text-slate-900">
  ...
  <div class="container m-auto px-4 py-8 md:px-6 md:py-14">
   <div class="dansom-card grid gap-5 p-5 md:grid-cols-3 md:gap-8 md:p-8">
    <div class="space-y-3 md:space-y-4">
     <div class="flex items-center justify-center rounded-2xl bg-gradient-to-br from-secondary/20 via-white to-quinary/25 p-4 ring-1 ring-secondary/20 md:p-6">
    ...
    <div class="md:col-span-2 space-y-3 md:space-y-4">
     <h5 class="font-DM text-2xl md:text-4xl font-bold text-primary">{{ service.fullTitle }}</h5>
     <p class="font-Zilla text-slate-700 text-base leading-relaxed md:text-lg">{{ service.subtitle }}</p>
